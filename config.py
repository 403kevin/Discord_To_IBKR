...
PER_ADD_SIGNAL_FUNDS_ALLOCATION = 1000
...
MAX_LOSS_STOP_PERCENT = 20        # Allowed pullback from highest price after breakeven
TIMEOUT_EXIT_MINUTES = 30          # Exit after this many minutes regardless of price
